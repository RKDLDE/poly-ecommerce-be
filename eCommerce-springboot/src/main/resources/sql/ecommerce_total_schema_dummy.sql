...
-- 장바구니 품목 시퀀스 생성
CREATE SEQUENCE seq_tb_basket_item
    START WITH 1
    INCREMENT BY 1
    NOCACHE
NOCYCLE;
...
INSERT INTO tb_basket_item (nb_basket_item, nb_basket, cn_basket_item_order, no_product, qt_basket_item_price, qt_basket_item, qt_basket_item_amount) VALUES (1, 1, 1, 'P_PEN_01', 1800, 10, 18000);
INSERT INTO tb_basket_item (nb_basket_item, nb_basket, cn_basket_item_order, no_product, qt_basket_item_price, qt_basket_item, qt_basket_item_amount) VALUES (2, 1, 2, 'P_SHA_01', 12000, 1, 12000);
INSERT INTO tb_basket_item (nb_basket_item, nb_basket, cn_basket_item_order, no_product, qt_basket_item_price, qt_basket_item, qt_basket_item_amount) VALUES (3, 1, 3, 'P_DIA_01', 32000, 2, 64000);
...
/* 이정상(user02) 주문 2 */
INSERT INTO tb_order VALUES ('ORD_20260515_02', 'user02', 46300, '이정상', '광명시 일직동', SYSDATE, '10');
INSERT INTO tb_order_item VALUES ('OI_03', 'ORD_20260515_02', 1, 'P_PEN_11', 4000, 3); -- 부모 주문번호(02) 일치
INSERT INTO tb_order_item VALUES ('OI_04', 'ORD_20260515_02', 2, 'P_SHA_11', 85000, 1);

/* 이정상(user02) 주문 3 */
INSERT INTO tb_order VALUES ('ORD_20260515_03', 'user02', 46300, '이정상', '광명시 일직동', SYSDATE, '10');
INSERT INTO tb_order_item VALUES ('OI_05', 'ORD_20260515_03', 1, 'P_PEN_11', 4000, 3); -- 부모 주문번호(03) 일치
INSERT INTO tb_order_item VALUES ('OI_06', 'ORD_20260515_03', 2, 'P_SHA_11', 85000, 1);

/* 김정상(user01) 주문 */
INSERT INTO tb_order VALUES ('ORD_20260515_04', 'user01', 46300, '김정상', '경기도 부천시', SYSDATE, '10');
INSERT INTO tb_order_item VALUES ('OI_07', 'ORD_20260515_04', 1, 'P_PEN_11', 4000, 3); -- 안 겹치는 새 PK 부여 (07)
INSERT INTO tb_order_item VALUES ('OI_08', 'ORD_20260515_04', 2, 'P_SHA_11', 85000, 1); -- 안 겹치는 새 PK 부여 (08)

-- 기존 시퀀스 삭제
DROP SEQUENCE seq_tb_basket;
DROP SEQUENCE seq_tb_basket_item;

CREATE SEQUENCE seq_tb_basket START WITH 2 INCREMENT BY 1 NOCACHE NOCYCLE;
CREATE SEQUENCE seq_tb_basket_item START WITH 4 INCREMENT BY 1 NOCACHE NOCYCLE;
COMMIT;